...
// @public
export function exportTaskPaper(
...
// @public
export function importTaskPaper(
  content: string,
...
// @public
export function runAppleScriptFile<T>(
  filePath: string,
  args?: string[]
): Promise<AppleScriptResult<T>>;
