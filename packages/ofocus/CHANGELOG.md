...
- dfdb766: Add auto-paginating async iteration over list queries
...
- 6a1195f: Add agent-docs auto-generator infrastructure under `scripts/generate-agent-docs.ts` and a root `pnpm generate:agent-docs` script.
...
- 90d3b85: Correct pagination helper docs and generic error message
...
- cfc89de: Fix dropped/blocked/available/effectivelyCompleted/effectivelyDropped filters to use the OmniJS Task.Status enum
